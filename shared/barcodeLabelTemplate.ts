...
export const LABEL_SAMPLE_TEMPLATES: LabelSampleTemplate[] = [
  ...
  },
  {
    ...
    description: 'Large shelf sticker with branding, product details, and barcode.',
    template: {
  ...
  {
    id: 'qr-dual-38x25',
    name: 'Barcode + QR 38×25 mm',
    description: 'Linear EAN-13 barcode and QR code together on one small label.',
    template: {
      name: 'Barcode + QR 38×25mm',
      description: 'Dual symbology label for POS and mobile scan',
      widthMm: 38,
      heightMm: 25,
      orientation: 'landscape',
      status: 'draft',
      ...
      elements: [
        {
          ...
          zIndex: 1,
          visible: true,
          properties: { fieldKey: 'product.name', fontSizePt: 6.5, fontWeight: 'bold' },
        },
        {
          id: 'el-mrp',
          type: 'field',
          ...
          zIndex: 2,
          visible: true,
          properties: { prefix: 'MRP ', fieldKey: 'product.price', fontSizePt: 5.5 },
        },
        {
          id: 'el-qr',
          type: 'qr',
