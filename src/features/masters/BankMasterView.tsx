    ...
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      <div className="flex items-center gap-4 flex-wrap">
        ...
        <div className="flex-1">
          <h2 className="text-xl font-bold">Bank Master</h2>
          <p className="text-sm text-gray-500">Manage bank accounts</p>
        </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="text-xs font-bold text-gray-400 uppercase border-b border-gray-50">
                ...
                <th className="px-3 py-3 sm:px-6 sm:py-4">Account No</th>
                <th className="px-3 py-3 sm:px-6 sm:py-4">Bank</th>
                <th className="px-3 py-3 sm:px-6 sm:py-4">Branch</th>
                <th className="px-3 py-3 sm:px-6 sm:py-4">IFSC</th>
        ...
        <CsvImport
          ...
          onImport={async rows => {
            try {
              ...
              const result = await fetchApi<{ success: number; errors: string[] }>('/banks/batch', {
                method: 'POST',
              ...
              return {
                success: 0,
                errors: [err instanceof Error ? err.message : 'Import failed — no banks were added'],
              };
            }
          }}
        />
