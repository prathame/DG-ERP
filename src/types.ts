export type Tab = 'dashboard' | 'warranty' | 'rewards' | 'replacements' | 'inventory' | 'purchases' | 'sales' | 'distribution' | 'quotations' | 'orders' | 'finance' | 'accounts' | 'payroll' | 'verification' | 'settings';
