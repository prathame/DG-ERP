...
export function DownloadPage() {
  ...
  const arm64 = release?.assets.find(a => a.name.includes('arm64') && a.name.endsWith('.dmg'));
      ...
      <div className="max-w-3xl mx-auto px-4 pt-28 pb-20">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-14">
          ...
          <p className="text-white/50 text-lg">
            {loading ? 'Fetching latest release...' : release ? `Version ${release.tag_name} · ${formatDate(release.published_at)}` : 'Download Dhando for Mac'}
          </p>
        </motion.div>
        ...
        {error && (
          <div className="text-center py-10 text-white/40">
            <p>Could not fetch latest release.</p>
          ...
          <div className="space-y-6">
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
              ...
              <div className="px-6 py-4 space-y-3">
                ...
                {!arm64 && !intel && <p className="text-white/30 text-sm py-2">No release assets found yet.</p>}
              </div>
            </motion.div>
            ...
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
              ...
              <div>
                <div className="font-semibold mb-0.5">Windows</div>
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.4 }}
              ...
              <h3 className="font-bold mb-3 text-sm text-white/60 uppercase tracking-widest">First time installing?</h3>
