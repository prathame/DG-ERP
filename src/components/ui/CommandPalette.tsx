...
import { Search, LayoutDashboard, Package, ShoppingCart, ShoppingBag, ScanSearch, FileText, IndianRupee, ShieldCheck, RefreshCw, Gift, BarChart3, Settings, X } from 'lucide-react';
import { cn } from '../../lib/utils';

type PaletteItem = { id: string; label: string; icon: React.ComponentType<{ size?: number; className?: string }>; section?: string };
