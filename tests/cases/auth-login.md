...
| 3b | Browser ERP blocked | Open `/{slug}` or a saved session in a normal browser | “Use the Dhandho app” screen + Download link; no login/workspace. API returns `403 APP_ONLY` |
