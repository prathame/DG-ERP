...
| 13 | Menu position | Open Settings → Appearance. Pick Top or Bottom. | Group menus open as dropdowns (no expand button). Settings only from profile menu. Subscription banner above everything |
