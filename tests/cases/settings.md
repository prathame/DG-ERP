...
| 12 | How to use (shop + accountant) | Open Settings → How to use. Switch Shop / Accountant. Open a topic. Switch language. Turn a nav tab off in Preferences. | Guide lists steps in the selected language and hides topics for tabs that are off |
