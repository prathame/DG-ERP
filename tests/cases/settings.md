...
| 13 | Menu position | Open Settings → Appearance. Pick Top or Bottom. | Menu shows grouped tabs (Analytics, Operations, Finance, Inventory). Bottom adds a floating shortcut bar. Subscription banner sits above everything |
