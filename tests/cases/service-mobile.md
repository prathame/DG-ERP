...
| 5d3 | Client invoice PDF after create | Masters → Client → New Invoice → Create & Send | Success screen offers Download/Print PDF; Done closes. Existing invoice rows also have PDF button |
