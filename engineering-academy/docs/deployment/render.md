...
| `PUBLIC_APP_URL` | Static `https://dhandho.app` | The canonical public URL, used wherever the server needs to construct absolute links (e.g. invite links, PDF footers) |
