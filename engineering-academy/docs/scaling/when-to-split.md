---
sidebar_label: When To Split
title: When To Split
description: Dhandho Engineering Academy — scaling/when-to-split
---

# When To Split

:::tip Curriculum chapter
Part of the **Dhandho Engineering Academy** (`scaling/when-to-split`). Built for ownership transfer of DG-ERP — not a wiki stub.
:::
