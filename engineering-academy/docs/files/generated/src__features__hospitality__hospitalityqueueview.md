---
sidebar_label: "HospitalityQueueView.tsx"
title: "File src/features/hospitality/HospitalityQueueView.tsx"
description: "Deep walkthrough of src/features/hospitality/HospitalityQueueView.tsx in DG-ERP / Dhandho"
---

# File walkthrough: `src/features/hospitality/HospitalityQueueView.tsx`
...
`src/features/hospitality/HospitalityQueueView.tsx` is part of Dhandho (DG-ERP). Approximate size: **249 lines**.
...
**Exported names:** `HospitalityQueueView`

**Classes:** _none_

## Functions (1 detected)

### Function: HospitalityQueueView

```ts
HospitalityQueueView()
```

| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `src/features/hospitality/HospitalityQueueView.tsx`. Open the source and read the body. |
| Parameters | See signature above. |
| What breaks if removed | Search the repo for `HospitalityQueueView` before deleting. |
...
rg -n "HospitalityQueueView" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```

## Performance impact

Line count **249**. Large view/route files are refactor candidates.
...
1. Open `src/features/hospitality/HospitalityQueueView.tsx` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `src__features__hospitality__hospitalityqueueview`*
