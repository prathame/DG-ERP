---
sidebar_label: "TermsOfService.tsx"
title: "File src/components/layout/TermsOfService.tsx"
description: "Deep walkthrough of src/components/layout/TermsOfService.tsx in DG-ERP / Dhandho"
---

# File walkthrough: `src/components/layout/TermsOfService.tsx`
...
`src/components/layout/TermsOfService.tsx` is part of Dhandho (DG-ERP). Approximate size: **108 lines**.
...
| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `src/components/layout/TermsOfService.tsx`. Open the source and read the body. |
| Parameters | See signature above. |
| What breaks if removed | Search the repo for `TermsOfService` before deleting. |
...
rg -n "TermsOfService" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```

## Performance impact

Line count **108**. Large view/route files are refactor candidates.
...
1. Open `src/components/layout/TermsOfService.tsx` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `src__components__layout__termsofservice`*
