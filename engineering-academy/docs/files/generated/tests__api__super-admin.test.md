---
sidebar_label: "super-admin.test.ts"
title: "File tests/api/super-admin.test.ts"
description: "Deep walkthrough of tests/api/super-admin.test.ts in DG-ERP / Dhandho"
---

# File walkthrough: `tests/api/super-admin.test.ts`
...
`tests/api/super-admin.test.ts` is part of Dhandho (DG-ERP). Approximate size: **112 lines**.
...
rg -n "super-admin.test" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `tests/api/super-admin.test.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `tests__api__super-admin.test`*
