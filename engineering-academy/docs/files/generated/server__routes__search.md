---
sidebar_label: "search.ts"
title: "File server/routes/search.ts"
description: "Deep walkthrough of server/routes/search.ts in DG-ERP / Dhandho"
---

# File walkthrough: `server/routes/search.ts`
...
rg -n "search" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `server/routes/search.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `server__routes__search`*
