---
sidebar_label: "preload.ts"
title: "File electron/onprem/preload.ts"
description: "Deep walkthrough of electron/onprem/preload.ts in DG-ERP / Dhandho"
---

# File walkthrough: `electron/onprem/preload.ts`
...
`electron/onprem/preload.ts` is part of Dhandho (DG-ERP). Approximate size: **20 lines**.
...
rg -n "preload" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```

## Performance impact

Line count **20**. Large view/route files are refactor candidates.
...
1. Open `electron/onprem/preload.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `electron__onprem__preload`*
