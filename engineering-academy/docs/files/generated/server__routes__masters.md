---
sidebar_label: "masters.ts"
title: "File server/routes/masters.ts"
description: "Deep walkthrough of server/routes/masters.ts in DG-ERP / Dhandho"
---

# File walkthrough: `server/routes/masters.ts`
...
rg -n "masters" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `server/routes/masters.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `server__routes__masters`*
