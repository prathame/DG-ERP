---
sidebar_label: "price-resolve.test.ts"
title: "File tests/unit/price-resolve.test.ts"
description: "Deep walkthrough of tests/unit/price-resolve.test.ts in DG-ERP / Dhandho"
---

# File walkthrough: `tests/unit/price-resolve.test.ts`
...
`tests/unit/price-resolve.test.ts` is part of Dhandho (DG-ERP). Approximate size: **70 lines**.
...
rg -n "price-resolve.test" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `tests/unit/price-resolve.test.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `tests__unit__price-resolve.test`*
