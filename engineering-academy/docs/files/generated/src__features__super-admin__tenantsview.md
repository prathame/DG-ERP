---
sidebar_label: "TenantsView.tsx"
title: "File src/features/super-admin/TenantsView.tsx"
description: "Deep walkthrough of src/features/super-admin/TenantsView.tsx in DG-ERP / Dhandho"
---

# File walkthrough: `src/features/super-admin/TenantsView.tsx`
...
`src/features/super-admin/TenantsView.tsx` is part of Dhandho (DG-ERP). Approximate size: **53 lines**.
...
```ts
TenantsView({ onSelectTenant }: TenantsViewProps)
```

| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `src/features/super-admin/TenantsView.tsx`. Open the source and read the body. |
| Parameters | See signature above. |
| What breaks if removed | Search the repo for `TenantsView` before deleting. |
...
rg -n "TenantsView" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `src/features/super-admin/TenantsView.tsx` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `src__features__super-admin__tenantsview`*
