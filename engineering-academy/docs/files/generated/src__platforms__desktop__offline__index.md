...
title: "File src/platforms/desktop/offline/index.ts"
description: "Deep walkthrough of src/platforms/desktop/offline/index.ts in DG-ERP / Dhandho"
---

# File walkthrough: `src/platforms/desktop/offline/index.ts`
...
`src/platforms/desktop/offline/index.ts` is part of Dhandho (DG-ERP). Approximate size: **2 lines**.
...
Line count **2**. Large view/route files are refactor candidates.
...
1. Open `src/platforms/desktop/offline/index.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `src__platforms__desktop__offline__index`*
