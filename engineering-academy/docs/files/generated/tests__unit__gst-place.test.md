---
sidebar_label: "gst-place.test.ts"
title: "File tests/unit/gst-place.test.ts"
description: "Deep walkthrough of tests/unit/gst-place.test.ts in DG-ERP / Dhandho"
---

# File walkthrough: `tests/unit/gst-place.test.ts`
...
`tests/unit/gst-place.test.ts` is part of Dhandho (DG-ERP). Approximate size: **33 lines**.
...
rg -n "gst-place.test" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `tests/unit/gst-place.test.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `tests__unit__gst-place.test`*
