---
sidebar_label: "audit.ts"
title: "File server/routes/audit.ts"
description: "Deep walkthrough of server/routes/audit.ts in DG-ERP / Dhandho"
---

# File walkthrough: `server/routes/audit.ts`
...
| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `server/routes/audit.ts`. Open the source and read the body. |
...
rg -n "audit" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `server/routes/audit.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `server__routes__audit`*
