---
sidebar_label: "planLimits.ts"
title: "File server/utils/planLimits.ts"
description: "Deep walkthrough of server/utils/planLimits.ts in DG-ERP / Dhandho"
---

# File walkthrough: `server/utils/planLimits.ts`
...
| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `server/utils/planLimits.ts`. Open the source and read the body. |
| Parameters | See signature above. |
| What breaks if removed | Search the repo for `checkPlanLimit` before deleting. |
...
rg -n "planLimits" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `server/utils/planLimits.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `server__utils__planlimits`*
