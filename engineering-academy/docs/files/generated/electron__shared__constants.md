---
sidebar_label: "constants.ts"
title: "File electron/shared/constants.ts"
description: "Deep walkthrough of electron/shared/constants.ts in DG-ERP / Dhandho"
---

# File walkthrough: `electron/shared/constants.ts`
...
`electron/shared/constants.ts` is part of Dhandho (DG-ERP). Approximate size: **4 lines**.
...
**Exported names:** `CLOUD_API`, `LOCAL_PG_PORT`, `HEARTBEAT_INTERVAL_MS`
...
rg -n "constants" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```

## Performance impact

Line count **4**. Large view/route files are refactor candidates.
...
1. Open `electron/shared/constants.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `electron__shared__constants`*
