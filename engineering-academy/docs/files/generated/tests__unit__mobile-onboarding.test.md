---
sidebar_label: "mobile-onboarding.test.ts"
title: "File tests/unit/mobile-onboarding.test.ts"
description: "Deep walkthrough of tests/unit/mobile-onboarding.test.ts in DG-ERP / Dhandho"
---

# File walkthrough: `tests/unit/mobile-onboarding.test.ts`
...
`tests/unit/mobile-onboarding.test.ts` is part of Dhandho (DG-ERP). Approximate size: **39 lines**.
...
rg -n "mobile-onboarding.test" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `tests/unit/mobile-onboarding.test.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `tests__unit__mobile-onboarding.test`*
