---
sidebar_label: "globalSetup.ts"
title: "File tests/globalSetup.ts"
description: "Deep walkthrough of tests/globalSetup.ts in DG-ERP / Dhandho"
---

# File walkthrough: `tests/globalSetup.ts`
...
| What breaks if removed | Search the repo for `requireEnv` before deleting. |
...
rg -n "globalSetup" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `tests/globalSetup.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `tests__globalsetup`*
