---
sidebar_label: "masters2.test.ts"
title: "File tests/api/masters2.test.ts"
description: "Deep walkthrough of tests/api/masters2.test.ts in DG-ERP / Dhandho"
---

# File walkthrough: `tests/api/masters2.test.ts`
...
`tests/api/masters2.test.ts` is part of Dhandho (DG-ERP). Approximate size: **249 lines**.
...
```ts
fetchCounts(tenantId: string)
```

| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `tests/api/masters2.test.ts`. Open the source and read the body. |
| Parameters | See signature above. |
| What breaks if removed | Search the repo for `fetchCounts` before deleting. |
...
rg -n "masters2.test" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `tests/api/masters2.test.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `tests__api__masters2.test`*
