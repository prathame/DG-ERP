---
sidebar_label: "audit.test.ts"
title: "File tests/api/audit.test.ts"
description: "Deep walkthrough of tests/api/audit.test.ts in DG-ERP / Dhandho"
---

# File walkthrough: `tests/api/audit.test.ts`
...
`tests/api/audit.test.ts` is part of Dhandho (DG-ERP). Approximate size: **119 lines**.
...
rg -n "audit.test" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `tests/api/audit.test.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `tests__api__audit.test`*
