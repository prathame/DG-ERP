---
sidebar_label: "SuperAdminLogin.tsx"
title: "File src/features/super-admin/SuperAdminLogin.tsx"
description: "Deep walkthrough of src/features/super-admin/SuperAdminLogin.tsx in DG-ERP / Dhandho"
---

# File walkthrough: `src/features/super-admin/SuperAdminLogin.tsx`
...
`src/features/super-admin/SuperAdminLogin.tsx` is part of Dhandho (DG-ERP). Approximate size: **90 lines**.
...
**Exported names:** `SuperAdminLogin`
...
```ts
SuperAdminLogin({ onLogin }: { onLogin: (user: SuperAdminUser)
```

| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `src/features/super-admin/SuperAdminLogin.tsx`. Open the source and read the body. |
| Parameters | See signature above. |
| What breaks if removed | Search the repo for `SuperAdminLogin` before deleting. |
...
rg -n "SuperAdminLogin" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `src/features/super-admin/SuperAdminLogin.tsx` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `src__features__super-admin__superadminlogin`*
