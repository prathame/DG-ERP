---
sidebar_label: "bootstrap.ts"
title: "File src/platforms/mobile/online/bootstrap.ts"
description: "Deep walkthrough of src/platforms/mobile/online/bootstrap.ts in DG-ERP / Dhandho"
---

# File walkthrough: `src/platforms/mobile/online/bootstrap.ts`
...
`src/platforms/mobile/online/bootstrap.ts` is part of Dhandho (DG-ERP). Approximate size: **41 lines**.
...
**Exported names:** `initCapacitorApp`
...
| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `src/platforms/mobile/online/bootstrap.ts`. Open the source and read the body. |
| Parameters | See signature above. |
| What breaks if removed | Search the repo for `initCapacitorApp` before deleting. |
...
rg -n "bootstrap" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```
...
1. Open `src/platforms/mobile/online/bootstrap.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `src__platforms__mobile__online__bootstrap`*
