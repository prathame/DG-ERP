---
sidebar_label: "hospApi.ts"
title: "File src/features/hospitality/hospApi.ts"
description: "Deep walkthrough of src/features/hospitality/hospApi.ts in DG-ERP / Dhandho"
---

# File walkthrough: `src/features/hospitality/hospApi.ts`
...
`src/features/hospitality/hospApi.ts` is part of Dhandho (DG-ERP). Approximate size: **87 lines**.
...
**Exported names:** `HospTable`, `HospMenuItem`, `HospOrderDetail`, `hospApi`
...
rg -n "hospApi" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```

## Performance impact

Line count **87**. Large view/route files are refactor candidates.
...
1. Open `src/features/hospitality/hospApi.ts` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `src__features__hospitality__hospapi`*
