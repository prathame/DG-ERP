---
sidebar_label: "VendorMasterView.tsx"
title: "File src/features/masters/VendorMasterView.tsx"
description: "Deep walkthrough of src/features/masters/VendorMasterView.tsx in DG-ERP / Dhandho"
---

# File walkthrough: `src/features/masters/VendorMasterView.tsx`
...
`src/features/masters/VendorMasterView.tsx` is part of Dhandho (DG-ERP). Approximate size: **232 lines**.
...
**Exported names:** `VendorMasterView`
...
```ts
VendorMasterView({ onBack, onRefresh, businessType = 'manufacturer' }: { onBack: ()
```

| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `src/features/masters/VendorMasterView.tsx`. Open the source and read the body. |
| Parameters | See signature above. |
| What breaks if removed | Search the repo for `VendorMasterView` before deleting. |
...
rg -n "VendorMasterView" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```

## Performance impact

Line count **232**. Large view/route files are refactor candidates.
...
1. Open `src/features/masters/VendorMasterView.tsx` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `src__features__masters__vendormasterview`*
