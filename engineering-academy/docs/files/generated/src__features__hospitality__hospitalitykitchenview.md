---
sidebar_label: "HospitalityKitchenView.tsx"
title: "File src/features/hospitality/HospitalityKitchenView.tsx"
description: "Deep walkthrough of src/features/hospitality/HospitalityKitchenView.tsx in DG-ERP / Dhandho"
---

# File walkthrough: `src/features/hospitality/HospitalityKitchenView.tsx`
...
`src/features/hospitality/HospitalityKitchenView.tsx` is part of Dhandho (DG-ERP). Approximate size: **174 lines**.
...
**Exported names:** `HospitalityKitchenView`

**Classes:** _none_

## Functions (1 detected)

### Function: HospitalityKitchenView

```ts
HospitalityKitchenView()
```

| Aspect | Detail |
| --- | --- |
| Purpose | Symbol in `src/features/hospitality/HospitalityKitchenView.tsx`. Open the source and read the body. |
| Parameters | See signature above. |
| What breaks if removed | Search the repo for `HospitalityKitchenView` before deleting. |
...
rg -n "HospitalityKitchenView" --glob '!node_modules' -g '*.ts' -g '*.tsx'
```

## Performance impact

Line count **174**. Large view/route files are refactor candidates.
...
1. Open `src/features/hospitality/HospitalityKitchenView.tsx` in the IDE.
...
*Generated by scripts/generate-file-deepdives.mjs · slug: `src__features__hospitality__hospitalitykitchenview`*
