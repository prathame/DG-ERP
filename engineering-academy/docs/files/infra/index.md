...
sidebar_label: Index
title: Index
description: Dhandho Engineering Academy — files/infra/index
---

# Index

:::tip Curriculum chapter
Part of the **Dhandho Engineering Academy** (`files/infra/index`). Built for ownership transfer of DG-ERP — not a wiki stub.
:::
