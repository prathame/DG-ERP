...
sidebar_label: Ci
title: Ci
description: Dhandho Engineering Academy — files/infra/ci
---

# Ci

:::tip Curriculum chapter
Part of the **Dhandho Engineering Academy** (`files/infra/ci`). Built for ownership transfer of DG-ERP — not a wiki stub.
:::
