...
sidebar_label: Vite
title: Vite
description: Dhandho Engineering Academy — files/infra/vite
---

# Vite

:::tip Curriculum chapter
Part of the **Dhandho Engineering Academy** (`files/infra/vite`). Built for ownership transfer of DG-ERP — not a wiki stub.
:::
