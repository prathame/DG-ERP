---
sidebar_label: Module Authz
title: Module Authz
description: Dhandho Engineering Academy — learning/module-authz
---

# Module Authz

:::tip Curriculum chapter
Part of the **Dhandho Engineering Academy** (`learning/module-authz`). Built for ownership transfer of DG-ERP — not a wiki stub.
:::
