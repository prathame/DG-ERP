---
sidebar_label: Module Distribution
title: Module Distribution
description: Dhandho Engineering Academy — learning/module-distribution
---

# Module Distribution

:::tip Curriculum chapter
Part of the **Dhandho Engineering Academy** (`learning/module-distribution`). Built for ownership transfer of DG-ERP — not a wiki stub.
:::
